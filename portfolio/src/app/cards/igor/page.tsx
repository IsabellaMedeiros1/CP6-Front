...
export default function Igor() {
  ...
  useEffect(() => {
    const fetchNotes = async () => {
      try {
        const response = await fetch('http://localhost:3000/api/base-notas/5');
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-10 flex flex-col items-center">
      <div className="form-container mb-10 bg-blue-300 border border-gray-400 rounded-lg p-6 border-collapse">
        ...
        />
        <div className="ml-6">
          <h1 className="titulo-nome">Igor Werneck Jacobosque</h1>
          <p className="descricao">Estudante da faculdade FIAP, cursando Análise e Desenvolvimento de Sistemas, turma 1TDSPM.</p>
          <div className="mt-4 flex space-x-4">
            <Link href="https://www.linkedin.com/in/igor-werneck-jacobosque-b7080418a/" target='_blank'><Linkedin className="text-3xl hover:text-blue-400 transition duration-300" /></Link>
            <Link href="https://github.com/IgorWJ" target='_blank'><GitHub className="text-3xl hover:text-blue-400 transition duration-300" /></Link>
            <Link href="https://www.instagram.com/igorwerneckk/" target='_blank'><Insta className="text-3xl hover:text-blue-400 transition duration-300" /></Link>
          </div>
        </div>
      </div>
